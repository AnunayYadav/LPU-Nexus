        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 md:gap-4">
          {isLoading ? (
            <div className="col-span-full flex flex-col items-center justify-center py-20 animate-pulse">
              <div className="w-7 h-7 md:w-8 md:h-8 border-3 md:border-4 border-orange-500 border-t-transparent rounded-full animate-spin mb-4"></div>
              <p className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-slate-500">Syncing...</p>
            </div>
          ) : files.length > 0 ? (
            ...
            <div className="col-span-full py-16 text-center">
               ...
               <p className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-slate-400">Empty Library</p>
            </div>
          )}
        </div>
      </div>
                ...
                <>
                  ...
                  <div className="p-6 md:p-8 pt-0 flex-shrink-0 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-white/5">
                    <button 
                      ...
                      className="w-full bg-orange-600 text-white py-3.5 md:py-4 rounded-xl md:rounded-2xl font-black text-[9px] md:text-[10px] uppercase tracking-widest shadow-xl active:scale-95 disabled:opacity-50 transition-all"
                    >
